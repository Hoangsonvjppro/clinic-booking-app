...
export default function PaymentPage() {
    ...
    return (
        <div>
            ...
            <div className={`min-h-screen flex flex-col items-center transition-colors duration-300 ${isDark ? "bg-cyan-950 text-white" : "bg-gray-50 text-gray-900"}`}>
                {/* Header */}
                <div className={`flex items-center mt-5 ${isDark ? "text-white" : "text-gray-900"}`}>
                    <img
                        src="/logo.svg"
                        alt="Your Store"
